...
const generateHeader = () => {
    ...
    <div class="container">
        <div class="header">
            <button class="btn btn-burger" aria-label="Відкрити меню">
